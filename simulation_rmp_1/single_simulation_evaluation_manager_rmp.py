...
JSON_FILE_PATH = "/home/matteo/Simulation_rmp/Run_20250917_143905/evaluation_results_with_distances.json"  # Path to the JSON file with simulation data

# Simulation number to recreate
SIMULATION_NUMBER = 4  # Change this to the simulation you want to recreate
